...
export function ContinueCard({ course }: ContinueCardProps) {
  ...
  return (
    <div className="relative glass rounded-2xl border-brand-primary/20 bg-gradient-to-br from-brand-primary/15 via-surface to-brand-secondary/10 p-6 overflow-hidden">
      {/* Decorative orbs */}
      ...
      <div className="relative">
        ...
        <h2 className="font-display text-2xl text-cream mb-1">{course.title}</h2>
        <p className="text-dim text-sm mb-4">{pct}% complete</p>
